...
REPO_DIR="/var/www/html/rambox"

# Path to Python downloader script
PY_SCRIPT="/root/rambox/rambox_downloader.py"

# Log file
LOG_FILE="/root/rambox/rambox-repo-update.log"

{
  echo "===== $(date -u '+%Y-%m-%d %H:%M:%S UTC') Starting Rambox repo update ====="
  ...
  keep_last_n "$REPO_DIR/Rambox-*.rpm" 3
